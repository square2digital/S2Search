...
go
    ...
    DECLARE @ThemeLogoURL_1 varchar(1000) = 'https://storages2searchwesteu.blob.core.windows.net/assets/assets/logos/Square_2_Logo_Colour_Blue_White_BG.svg'
	DECLARE @ThemeMissingImageURL_1 varchar(1000) = 'https://storages2searchwesteu.blob.core.windows.net/assets/assets/image-coming-soon.jpg' 
	...
	DECLARE @ThemeLogoURL_2 varchar(1000) = 'https://storages2searchwesteu.blob.core.windows.net/assets/assets/logos/Square_2_Logo_Colour_Blue_White_BG.svg'
	DECLARE @ThemeMissingImageURL_2 varchar(1000) = 'https://storages2searchwesteu.blob.core.windows.net/assets/assets/image-coming-soon.jpg' 
    ...
    DECLARE @ThemeLogoURL_3 varchar(1000) = 'https://storages2searchwesteu.blob.core.windows.net/assets/assets/logos/Square_2_Logo_Colour_Blue_White_BG.svg' 
	DECLARE @ThemeMissingImageURL_3 varchar(1000) = 'https://storages2searchwesteu.blob.core.windows.net/assets/assets/image-coming-soon.jpg' 
