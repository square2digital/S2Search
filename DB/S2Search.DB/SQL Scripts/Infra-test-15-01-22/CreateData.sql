...
go
	...
	DECLARE @SearchConfigurationMapping_6 uniqueidentifier = '0ad0b4cd-65bc-4f11-bcb7-d19e98185d72'
	...
	DECLARE @AzureDevEndpoint varchar(100) = 'demo.square2digital.com'		
	
	DECLARE @MarshallCarsEndpoint varchar(100) = 'marshallcars.s2search.co.uk'                 -- RED
	DECLARE @SaxtonVehicleSalesEndpoint varchar(100) = 'saxtonvehiclesales.s2search.co.uk'     -- BLUE
	DECLARE @WearsideAutoparcEndpoint varchar(100) = 'wearsideautoparc.s2search.co.uk'         -- GREEN
	...
	SET @DPMotorsEndpoint = @OktetoDevEndpoint
	SET @S2DemoEndpoint = @AzureDevEndpoint
    ...
    -- S2 Demo  - customer 6
	-- ******************    
    DECLARE @BusinessName_6 varchar(100) = 'S2 Demo'
	DECLARE @CustomerIndexName_6 varchar(100) = 's2-demo-vehicles'
	DECLARE @SearchIndexId_6 uniqueidentifier = '0035b210-40df-46b1-be49-58758a5c9cc3'
	DECLARE @ThemeId_6 uniqueidentifier = '3bbabbab-62a4-41f6-8b9f-ed0cbfab79ec' 
    DECLARE @ThemeLogoURL_6 varchar(1000) = 'https://dpdevstore.blob.core.windows.net/temp/assets/image-coming-soon.jpg'
	DECLARE @ThemeMissingImageURL_6 varchar(1000) = 'https://dpdevstore.blob.core.windows.net/temp/assets/logos/Square_2_Logo_Colour_Blue_White_BG.svg' 
    DECLARE @ThemePrimaryThemeColour_6 varchar(10) = '#006bd1'
    DECLARE @ThemeSecondaryThemeColour_6 varchar(10) = '#003c75'
	DECLARE @ThemeNavBarColourColour_6 varchar(10) = '#006bd1'   
     ...
     ***************************************************************************************/
	 ...
	 DECLARE @FeedSearchIndexId_6 uniqueidentifier = @SearchIndexId_6
	 DECLARE @FeedId_6 uniqueidentifier = 'd6b6410c-b7fc-435c-af2e-cf78ed843a17'
	 DECLARE @FeedUsername_6 varchar(100) = 'S2Demo_FTP_6'
     DECLARE @FeedPasswordHash_6 varchar(255) = 'G95DeSWUHGVF'
...
VALUES
	...
	PRINT '********************************'
	PRINT 'Inserting Test Customer 6 - '
	PRINT '********************************'
	...
	PRINT '********************************'
	PRINT 'Inserting Search Index for Test Customer 6 - '
	PRINT '********************************'
	...
	PRINT '********************************'
	PRINT 'Search Index Keys for Test Customer 6 - '
	PRINT '********************************'
	...
	VALUES
		(
			@SearchIndexId_6,
			@BusinessName_6 + ' test key',
			@SearchInstanceKeyId_QueryKey,
			@Now
		) 
	
	PRINT '********************************'
	PRINT 'Inserting Feed Entry for Test Customer 6 - '
	PRINT '********************************'
...
INSERT INTO [dbo].[Themes]
	...
	PRINT '********************************'
	PRINT 'Customer 6 Theme Details'
	PRINT '********************************'
