...
go
	...
	SET @SaxtonVehicleSalesEndpoint = @LocalDevEndpoint
	--SET @WearsideAutoparcEndpoint = @LocalDevEndpoint		
	--SET @JGilmartinMotorsEndpoint = @OktetoDevEndpoint
	SET @S2DemoEndpoint = @OktetoDevEndpoint
    ...
    -- S2 Demo  - customer 5
	-- ******************    
    DECLARE @BusinessName_5 varchar(100) = 'S2 Demo'
	DECLARE @CustomerIndexName_5 varchar(100) = 's2-demo-vehicles'
	DECLARE @SearchIndexId_5 uniqueidentifier = '8c663063-4217-4f54-973f-8faec6131b5b'
	DECLARE @ThemeId_5 uniqueidentifier = '8c663063-4217-4f54-973f-8faec6131b5b' 
    DECLARE @ThemeLogoURL_5 varchar(1000) = 'https://dpdevstore.blob.core.windows.net/temp/assets/image-coming-soon.jpg'
	DECLARE @ThemeMissingImageURL_5 varchar(1000) = 'https://dpdevstore.blob.core.windows.net/temp/assets/logos/Square_2_Logo_Colour_Blue_White_BG.svg' 
    DECLARE @ThemePrimaryThemeColour_5 varchar(10) = '#006bd1'
    DECLARE @ThemeSecondaryThemeColour_5 varchar(10) = '#003c75'
	DECLARE @ThemeNavBarColourColour_5 varchar(10) = '#006bd1'   
     ...
     ***************************************************************************************/
	 ...
	 DECLARE @FeedId_5 uniqueidentifier = 'd6b6410c-b7fc-435c-af2e-cf78ed843a17'
	 DECLARE @FeedUsername_5 varchar(100) = 'S2Demo_FTP_6'
     DECLARE @FeedPasswordHash_5 varchar(255) = 'G95DeSWUHGVF'
