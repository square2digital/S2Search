...
namespace S2Search.SFTPGo.Client.AutoRest
{
    ...
    public static partial class FolderExtensions
    {
            ...
            /// </param>
            public static ApiResponse Update(this IFolder operations, BaseVirtualFolder body, string mode = default(string))
            {
            ...
            /// </param>
            public static async Task<ApiResponse> UpdateAsync(this IFolder operations, BaseVirtualFolder body, string mode = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
