...
DECLARE
    ...
    StorageURI   TEXT := 'https://s2storage844.blob.core.windows.net';
    AdminKey  TEXT  := 'TO_BE_REPLACED_ADMIN_KEY';
    SecondaryKey   TEXT := 'TO_BE_REPLACED_SECONDARY_KEY';
    QueryKey TEXT := 'TO_BE_REPLACED_QUERY_KEY';
    Replicas INT := 1;
    Partitions INT := 1;
