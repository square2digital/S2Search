...
namespace Tests
{
    ...
    public class LuceneSyntaxHelperTests : TestBase
    {
        ...
        public void TestInitialize()
        {
            ...
            _synomynsServiceMock.Setup(x => x.GetGenericSynonyms(It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync(base.GetSynonymsList);
        }
        ...
        public void Test_GenerateLucenceSearchString_Yellow()
        {
            ...
            // act
            var result = _LuceneSyntaxHelper.Object.GenerateLuceneSearchString(searchStr, _faceCacheKey);
