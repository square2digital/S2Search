...
namespace Domain.Models
{
    ...
    {
        public bool UseGenericResponse { get; set; } = false;
    ...
    public class SearchSettings
    {
        ...
        public string DemoVehiclesIndexSchemaURL { get; set; }
        ...
        public IEnumerable<string> FacetNamesToMatchList
        {
            get
            {
                if (!string.IsNullOrEmpty(FacetNamesToMatch))
                {
                    ...
                    return JsonConvert.DeserializeObject<List<string>>(FacetNamesToMatch, options);
                }
        ...
        public IEnumerable<string> FacetOrderList
        {
            get
            {
                ...
                {
                    return JsonConvert.DeserializeObject<string[]>(FacetOrder);
                }
