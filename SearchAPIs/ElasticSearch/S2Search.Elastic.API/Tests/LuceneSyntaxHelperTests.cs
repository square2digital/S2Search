...
namespace Tests
{
    ...
    {
        private Mock<LuceneSyntaxHelper> _LuceneSyntaxHelper = new Mock<LuceneSyntaxHelper>();
        ...
        private Mock<IElasticFacetService> _elasticFacetServiceMock = new Mock<IElasticFacetService>();
        private Mock<ISynonymsService> _synomynsServiceMock = new Mock<ISynonymsService>();
        private string _index = "s2-demo-generic";

        [TestInitialize]
        public void TestInitialize()
        {
            _synonymsHelperMock.Setup(x => x.GetSynonymsDictionary(It.IsAny<List<string>>())).Returns(GetSynonymsDictionary);
            _elasticFacetServiceMock.Setup(x => x.GetOrSetDefaultFacets(_index))
                .Returns(FacetHelper.GetDefaultFacetsRequest);

            _LuceneSyntaxHelper = new Mock<LuceneSyntaxHelper>(GetLoggerMock.Object,
                                                                GetAppsettigsMock.Object,
                                                                _synonymsHelperMock.Object,
                                                                _elasticFacetServiceMock.Object,
                                                                _synomynsServiceMock.Object);

            _synomynsServiceMock.Setup(x => x.GetGenericSynonyms(It.IsAny<string>())).ReturnsAsync(base.GetSynonymsList);
        }
        ...
        //    // act
        //    var result = _LuceneSyntaxHelper.Object.GenerateLuceneSearchString(searchStr);
        ...
        //    // act
        //    var result = _LuceneSyntaxHelper.Object.EscapeLuceneSpecialCharacters(searchStr);
        ...
        //    // act
        //    var result = _LuceneSyntaxHelper.Object.ContainsSpecialCharacters(searchStr);
