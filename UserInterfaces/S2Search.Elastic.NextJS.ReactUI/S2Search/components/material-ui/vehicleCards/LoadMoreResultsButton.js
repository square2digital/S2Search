...
import { MobileMaxWidth, DefaultPageSize } from "../../../common/Constants";
...
const LoadMoreResultsButton = (props) => {
  ...
  const toggleLoadMore = () => {
    //debugger;
    props.savePageFrom(props.reduxPageFrom + DefaultPageSize);
    //props.savePageFrom(props.reduxPageFrom + 1);
  };
  ...
  const showLoadMoreButton = () => {
    ...
    if (DefaultPageSize > props.reduxVehicleData.length) {
      return false;
    }
